<svg
    data-ui="signal-stream"
    aria-hidden="true"
    focusable="false"
    viewBox="0 0 650 430"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    {{ $attributes->class('landing-signal-stream') }}
>
    <path class="landing-stream-line landing-stream-line-blue" d="M20 432C52 341 123 303 236 259C330 223 358 185 373 116C381 79 404 59 444 59H550" />
    <path class="landing-stream-line landing-stream-line-mint" d="M45 435C75 352 139 319 250 277C350 239 381 196 391 137C397 100 420 81 461 81H560" />
    <path class="landing-stream-line landing-stream-line-amber" d="M72 438C101 365 155 337 269 295C368 258 400 216 409 158C415 123 438 104 477 104H570" />
